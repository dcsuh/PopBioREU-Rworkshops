...
library(tidyverse)
# Import data
passengers <- read_csv("data/train.csv") # how to name things readDOTcsv  vs read_csv
# Check out the first several observations of your dataframe
 #whats a dataframe
passengers #is data really binary? where did data come from?  How are missing values included?
```
...
passengers %>% 
  drop_na() %>% 
  summary() #parenthesis is important
```
